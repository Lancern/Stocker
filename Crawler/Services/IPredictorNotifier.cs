...
namespace Stocker.Crawler.Services.DependencyInjection
{
    ...
    public static class PredictorNotifierExtensions
    {
        ...
        /// <param name="predictorEndpoint">预测节点所在的主机。</param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="services"/>为null
        ///     或
        ///     <paramref name="predictorEndpoint"/>为null
        /// </exception>
        public static IServiceCollection AddDefaultPredictorNotifier(this IServiceCollection services,
                                                                     string predictorEndpoint)
        {
            if (services == null)
                throw new ArgumentNullException(nameof(services));
            if (predictorEndpoint == null)
                throw new ArgumentNullException(nameof(predictorEndpoint));
